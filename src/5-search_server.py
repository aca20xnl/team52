#! /usr/bin/env python3
# a template for the task 2 exercise
...
class SearchActionServer(object):
    ...
    # action server is initialised 
    # callback function is defined to encapsulate all the code that will be executed when action called
    def __init__(self):
